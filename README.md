...
| ------------------------------------------------------------------- | ------------------ | ---------------------- | -------------------------------------------------------------------------- | --------------------------------------------------------------------------------- |
| Collection of shocks (U.S.)                                         | Y                  |                        | 1_Master File_Federal Securities Laws                                        | 1_Output_Master File_Federal Securities Laws                                        |
| Collection of shocks (non-U.S.)                                     |                    | Y                      | 2_Master File_Global_Securities Laws                                         | 2_Output_Master File_Global_Securities Laws                                         |
| Generate U.S. papers                                                | Y                  |                        | 1_Master File_Federal Securities Laws                                        | 1_Output_Master File_Federal Securities Laws                                        |
| Generate non-U.S. papers                                            |                    | Y                      | 2_Master File_Global_Securities Laws                                         | 2_Output_Master File_Global_Securities Laws                                         |
| Comparing LLMs collection of shocks (U.S.)                          | Y                  |                        | 3_Master File_LLM Performance (ChatGPT & Gemini)_Identify_Federal Securities | 3_Output_Master File_LLM Performance (ChatGPT & Gemini)_Identify_Federal Securities |
| Comparing LLMs collection of shocks (non-U.S.)                      |                    | Y                      | 4_Master File_LLM Performance (ChatGPT & Gemini)_Identify_Global Securities  | 4_Output_Master File_LLM Performance (ChatGPT & Gemini)_Identify_Global Securities  |
| Alternative programming                                             | Y                  |                        | 5_Master File_Alternative Programming                                        | 5_Output_Master File_Alternative Programming                                        |
| Spurious correlation test (U.S.)                                    | Y                  |                        | 6_Master File_Federal Securities Laws_Spurious Correlation Assessment        | 6_Output_Master File_Federal Securities Laws_Spurious Correlation Assessment        |
| Spurious correlation test (non-U.S.)                                |                    | Y                      | 7_Master File_Global Securities Laws_Spurious Correlation Assessment         | 7_Output_Master File_Global Securities Laws_Spurious Correlation Assessment         |
| Data collection after knowledge cutoff date - Collections of shocks | Y                  |                        | 8_Master File_Data Collection Outside of Training Data                       | 8_Output_Master File_Data Collection Outside of Training Data                       |
| Data collection after knowledge cutoff date - Generate papers       | Y                  |                        | 8_Master File_Data Collection Outside of Training Data                       | 8_Output_Master File_Data Collection Outside of Training Data                       |
...
|Review AI-generated papers                                            |Y                   | Y                      | 11_Master File_AI Reviewer                                                    |11_Output_Master File_AI Reviewer    
